...
export default function Bake() {
    ...
    const handleChangeSwitch = (c, e) => {
        ...
        if (!first) {
            if (dev.current) {
                clearTimeout(dev.current)
            }
            setsecond(!second)
            dev.current = setTimeout(() => {
                setfirst(true)
                setsecond(true)
    ...
    return (
        <div className='bake container-fluid' style={{ backgroundColor: first ? "#ee9ca7" : "#000" }}>
            <div className="velas">
                <div className="fuego" style={{ display: first ? "none" : "block" }} />
                <div className="fuego" style={{ display: first ? "none" : "block" }} />
                <div className="fuego" style={{ display: first ? "none" : "block" }} />
                <div className="fuego" style={{ display: first ? "none" : "block" }} />
                <div className="fuego" style={{ display: first ? "none" : "block" }} />
            </div>
            {second ? "" : <img src='./img/removebg-preview.png' alt='Myyyyy' className='Myy' />}
            {second ? "" : <img src='./img/air.png' alt='Myyyyy' className='Air' />}
	...
	c-7.606-0.447-6.058-37.895-20.62-23.333c-10.167,10.166-15.972-0.747-25,12C119.547,443.568,121.798,416.515,111.547,415.233z
            ...
            <div className="text">
                <h1>Sinh nhật chắc chắn là phải có bánh rồi. <br></br>
                    Bánh này tôi tự làm cho bạn á :D </h1>
            </div>
            <div className='control row'>
                <div className='den col-12 col-md-6'>
                    <Switch className='onoffden' checkedChildren="on" unCheckedChildren="off" defaultChecked={true} onChange={handleChangeSwitch} />
                    {first ? <p>Bạn giúp tôi tắt công tắc đèn để tôi đốt nến cho bạn cầu nguyện </p> :
                        <p>Bật đèn tôi sẽ nhờ người giúp bạn thổi nến :D </p>}
                </div>
